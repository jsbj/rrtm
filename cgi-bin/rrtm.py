...
model_data['h2o'] = [model_data['rh'][i] * 611. * exp(2.501e6 /(461.5 * 273.15)) * exp(-2.501e6 / (461.5 * model_data['T'][i])) / (model_data['p'][i] * 10000.) for i in range(len(h2o))]

import sys; sys.stderr.write(str(model_data['h2o']))
